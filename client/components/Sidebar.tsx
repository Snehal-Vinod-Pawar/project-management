        ...
        <div className={sidebarClassNames}>
            <div className="flex h-[100%] w-full flex-col justify-start">
                ...
                <div className="z-50 flex min-h-[56px] w-64 items-center justify-between bg-white px-6 pt-3 dark:bg-dark-bg">
                    <div className="text-xl font-bold text-gray-800 dark:text-bg-dark-bg">
                        EDLIST
                    </div>
                ...
                {/* TEAM */}
                <div className="flex items-center gap-5 border-y-[1.5px] border-gray-100 px-8 py-4 dark:border-gray-200">
                    <Image
                        src="/logo.png"
                        alt="Logo"
                        width={40}
                    ...
                    />
                    <div>
                        <h3 className="text-md font-bold tracking-wide dark:text-black">
                            EDROH TEAM
                        </h3>
