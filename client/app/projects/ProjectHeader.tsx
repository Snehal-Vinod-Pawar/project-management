  ...
  return (
    <div className="px-4 xl:px-6">
        ...
        <div className="flex items-center justify-between">
          ...
          <button
            className="flex items-center rounded-md bg-blue-600 px-4 py-3 w-43 text-base font-medium text-white hover:bg-blue-500"
...
const TabButton = ({ name, icon, setActiveTab, activeTab }: TabButtonProps) => {
  ...
  return (
    <button
      className={`relative flex items-center gap-2 px-1 py-2 text-gray-500 after:absolute after:-bottom-[9px] after:left-0 after:h-[1px] after:w-full hover:text-blue-600 dark:text-neutral-500 dark:hover:text-gray sm:px-2 lg:px-4 ${
